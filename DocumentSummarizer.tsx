    ...
    <>
      ...
      <div className="bg-gray-100 min-h-screen flex items-start justify-center py-6 px-4 sm:px-6 lg:px-8">
        <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-[400px] mt-4">
          ...
          <p className="text- text-sm text-gray-500 mb-4">Supported extensions: .txt, .doc, .docx, .pdf</p>
          ...
          {isSummarized && (
            <div className="mt-4">
              ...
              <div className="mt-4 flex space-x-4 justify-end">
                <button className="py-2 px-6 bg-green-500 text-white rounded-md hover:bg-green-600">
                  Share
                </button>
                <button className="py-2 px-6 bg-yellow-500 text-white rounded-md hover:bg-yellow-600">
                  Export
                </button>
              </div>
            </div>
