			...
			{props.currentPage != "None" && (
				<div className="ml-auto flex items-center h-full ">
					<button
						...
						className="border-none bg-color_secondary cursor-pointer items-center pr-[10px]"
						disabled={!showProfileIcon}
					>
						{showProfileIcon && <img src={profileIcon} alt="profile" className="size-[56px]" />}
					</button>
					...
					{isDropdownOpen && (
						<div className="flex items-up justify-end bg-grey p-[8px] pt-[4px] pb-[2px] space-x-[8px]">
							...
							<div className="flex-row">
								...
								<a href="/profile" className="text-black no-underline hover:underline hover:text-biru mt-[10px] space-x-[4px] text-[10px] mr-[4px]">
									Edit My Profile
								</a>
								<span>|</span>
